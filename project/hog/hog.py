...
def roll_dice(num_rolls, dice=six_sided):
    ...
    while num_rolls > 0:
        ...
        outcome += result
        num_rolls -= 1
    return 1 if pig_out else outcome
    # END PROBLEM 1
...
def boar_brawl(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 2
    "*** YOUR CODE HERE ***"
    point = abs(opponent_score // 10 % 10 - player_score % 10) * 3
    if point > 1:
        return point
    else:
        return 1
...
def always_roll(n):
    ...
    # BEGIN PROBLEM 6
    "*** YOUR CODE HERE ***"
    def always_roll_n(player_score, oppoent_score):
        return n
...
def max_scoring_num_rolls(dice=six_sided, times_called=1000):
    ...
    # BEGIN PROBLEM 9
    "*** YOUR CODE HERE ***"
    ma = make_averaged(roll_dice, times_called)

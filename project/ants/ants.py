...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        distance = 0
        throw_destination = self.place
        while throw_destination != None:
            if self.lower_bound <= distance <= self.upper_bound and throw_destination.bees and not throw_destination.is_hive:
                return random_bee(throw_destination.bees)
            throw_destination = throw_destination.entrance
            distance += 1
        return None
        # REPLACE THIS LINE
        # END Problem 3 and 4

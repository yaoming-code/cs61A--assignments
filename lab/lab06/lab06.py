...
class BankAccount:
    ...
    def deposit(self, amount):
        ...
        self.transactions.append(Transaction(self.transaction_times, self.balance - amount, self.balance))
    ...
    def withdraw(self, amount):
        ...
        if amount > self.balance:
            self.transactions.append(Transaction(self.transaction_times, self.balance, self.balance))
            self.transaction_times += 1
